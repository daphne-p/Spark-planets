...
object JobML {
  ...
  def loadDataFrame(spark:SparkSession):DataFrame={
    val df = spark.read.parquet("/home/daphne/TP_Spark/tp_spark/cleanedDataFrame.parquet")
  ...
  def main(args: Array[String]): Unit = {
    ...
    // Saving the file
    sc1.parallelize(Seq(model), 1).saveAsObjectFile("/home/daphne/TP_Spark/tp_spark/planets.model")
  }
}
